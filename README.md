...
This repository serves as supplementary material for [this article](https://doi.org/10.1098/rspa.2022.0340). Here we provide code in Julia, Matlab and Python to simulate an axis-symmetric impact between a rigid sphere and a thin elastic membrane.
